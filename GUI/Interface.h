...
/* Requirements
 * 1) Static LOGIC library
 *		LOGIC Project > Properties > Config. Properties > Project Defaults > Configuration Type > Static Lib
 * 2) Reference to static LOGIC library
 *		GUI Project > Properties > Config. properties > C/C++ > Additional Include directories > <<insert directory>>
 * 3) Set UI as starting point
 *		GUI Project > set as start up project
 *		GUI Project > Properties > Linker > Advance > Entry point > type in: main
 * 4) Include References from Visual Studio or anywhere else
 *		GUI Project > Properties > Common Properties > Framework and References. Add the following references:
 *			- LOGIC
 *			- System
 *			- System.Data
 *			- System.Drawing
